...
func main() {
	...
	origins := handlers.AllowedOrigins([]string{"http://localhost:4200", "https://hromov.github.io", "https://main.d28u5hc4igk6xp.amplifyapp.com", os.Getenv("ORIGIN_ALLOWED")})
	log.Fatal(http.ListenAndServe(":"+port, handlers.CORS(credentials, methods, origins, headersOk)(router)))
}
